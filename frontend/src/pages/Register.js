    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (role === "teacher") {
                ...
                // delete payload.section; // Keep section for teachers
                delete payload.year;
        ...
        <div style={styles.container}>
            <form onSubmit={handleSubmit} style={styles.form}>
                ...
                <div style={styles.inputGroup}>
                    ...
                    <input type="email" name="email" value={formData.email} onChange={handleChange} required style={styles.input} placeholder="email@college.edu" />
                </div>
                <div style={styles.inputGroup}>
                ...
                {role === "student" && (
                    <>
                        <div style={styles.inputGroup}>
                            ...
                            <input type="text" name="name" value={formData.name} onChange={handleChange} required style={styles.input} placeholder="Arjun Kumar" />
                        </div>
                        <div style={styles.inputGroup}>
                            <label>Roll Number</label>
                            <input type="text" name="rollNo" value={formData.rollNo} onChange={handleChange} required style={styles.input} placeholder="22CS001" />
                        </div>
                        <div style={{ display: "flex", gap: "10px" }}>
                            <div style={{ ...styles.inputGroup, flex: 1 }}>
                                <label>Section</label>
                                <select name="section" value={formData.section} onChange={handleChange} required style={styles.input}>
                ...
                {role === "teacher" && (
                    <>
                        <div style={styles.inputGroup}>
                            <label>Full Name</label>
                            <input type="text" name="employeeName" value={formData.employeeName} onChange={handleChange} required style={styles.input} placeholder="Dr. Priya" />
                        </div>
                        <div style={styles.inputGroup}>
                            <label>Employee ID</label>
                            <input type="text" name="employeeId" value={formData.employeeId} onChange={handleChange} required style={styles.input} placeholder="TCH001" />
                        </div>
                        <div style={styles.inputGroup}>
                            <label>Subject Dealing</label>
                            <select name="subjectDealing" value={formData.subjectDealing} onChange={handleChange} required style={styles.input}>
